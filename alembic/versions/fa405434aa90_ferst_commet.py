...
Revision ID: fa405434aa90
Revises: 
Create Date: 2025-04-05 01:26:16.070417
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'POSTPONED', 'COMPLETED', name='taskstatus', length=50), nullable=False),
