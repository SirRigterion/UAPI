...
Revision ID: 4303e7118496
Revises: 
Create Date: 2025-04-04 15:05:16.294970
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'POSTPONED', 'COMPLETED', name='taskstatus'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['editor_id'], ['users.user_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
